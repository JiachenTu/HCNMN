#!/bin/bash
# Batch test V7 (Adaptive Rules) on selected test images

METHOD="V7"
OUTPUT_DIR="/nas/jiachen/graph_reasoning/HCNMN/inspect/batch_results/v7"
TEST_IMAGES="/nas/jiachen/graph_reasoning/HCNMN/inspect/test_images.txt"
DEVICE="cuda:0"

echo "=== V7 Adaptive Rules Batch Test ==="
echo "Device: $DEVICE"
...
for image_id in "${image_ids[@]}"; do
    ...
    timeout 300 conda run -n hcnmn python visualize_scene_graph_hierarchy_v7.py \
        --image_id "$image_id" \
