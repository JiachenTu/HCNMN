#!/bin/bash
# Batch test V8 (Basic LLM) on selected test images

METHOD="V8"
OUTPUT_DIR="/nas/jiachen/graph_reasoning/HCNMN/inspect/batch_results/v8"
TEST_IMAGES="/nas/jiachen/graph_reasoning/HCNMN/inspect/test_images.txt"
DEVICE="cuda:1"

echo "=== V8 Basic LLM Batch Test ==="
echo "Device: $DEVICE"
...
for image_id in "${image_ids[@]}"; do
    ...
    timeout 300 conda run -n qwen3 python visualize_scene_graph_hierarchy_v8.py \
        --image_id "$image_id" \
