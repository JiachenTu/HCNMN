#!/bin/bash
# Batch test V20 (Vision-Grounded VLM) on selected test images

METHOD="V20"
OUTPUT_DIR="/nas/jiachen/graph_reasoning/HCNMN/inspect/batch_results/v20"
TEST_IMAGES="/nas/jiachen/graph_reasoning/HCNMN/inspect/test_images.txt"
DEVICE="cuda:3"

echo "=== V20 Vision-Grounded VLM Batch Test ==="
echo "Device: $DEVICE"
